...
export type RegistrationStatus = { 'expired' : [] | [string] } |
  { 'pending' : [] | [string] } |
  { 'approved' : [] | [string] } |
  { 'rejected' : [] | [string] };
...
export interface _SERVICE {
  ...
  'approveRegistration' : ActorMethod<[Principal], undefined>,
  'assignCallerUserRole' : ActorMethod<[Principal, UserRole], undefined>,
  'getActiveStudents' : ActorMethod<[], Array<StudentProfile>>,
  'getCallerUserProfile' : ActorMethod<[], [] | [UserProfile]>,
  'getCallerUserRole' : ActorMethod<[], UserRole>,
  'getExpiredStudents' : ActorMethod<[], Array<StudentProfile>>,
  'getRemainingDays' : ActorMethod<[], [] | [bigint]>,
  'getUserProfile' : ActorMethod<[Principal], [] | [UserProfile]>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'isCallerApproved' : ActorMethod<[], boolean>,
  'isEmailTaken' : ActorMethod<[string], boolean>,
  'isRegistered' : ActorMethod<[], boolean>,
  'isSubscriptionActive' : ActorMethod<[], boolean>,
  'listApprovals' : ActorMethod<[], Array<UserApprovalInfo>>,
  'listPendingRegistrations' : ActorMethod<
    [],
    Array<[Principal, StudentProfile]>
  >,
  'rejectRegistration' : ActorMethod<[Principal, [] | [string]], undefined>,
